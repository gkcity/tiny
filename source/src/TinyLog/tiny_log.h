...
#define __tiny_log_H__
    ...
    #ifdef TINY_DEBUG
        #ifdef ESP
            #define LOG_D(tag, format, ...) {printf(tag); printf(" "); printf(format, ##__VA_ARGS__); printf("\n");}
            #define LOG_E(tag, format, ...) {printf(tag); printf(" "); printf(format, ##__VA_ARGS__); printf("\n");}
            #define LOG_I(tag, format, ...) {printf(tag); printf(" "); printf(format, ##__VA_ARGS__); printf("\n");}
            #define LOG_V(tag, format, ...) {printf(tag); printf(" "); printf(format, ##__VA_ARGS__); printf("\n");}
            #define LOG_W(tag, format, ...) {printf(tag); printf(" "); printf(format, ##__VA_ARGS__); printf("\n");}
        #else
